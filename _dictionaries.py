...
candidate_dir = {
      6  : [(250, 410, ["face-on", "edge-on-A"], ["ph2co", "c18o"]), 
            (470, 600, ["face-on", "edge-on-A"], ["ph2co", "c18o"]), 
            (580, 690, ["face-on", "edge-on-A", "edge-on-B"], ["ph2co", "c18o"]), 
            (710, 780, ["face-on", "edge-on-A"], ["ph2co", "c18o"]), 
            (820, 900, ["face-on", "edge-on-B"], ["ph2co", "c18o"]), 
            (960, 1050, ["face-on", "edge-on-A", "edge-on-B"], ["ph2co", "13co", "c18o"])],

      13 : [(440, 620, ["face-on", "edge-on-B"], ["ph2co", "c18o"]),
            (820, 1050, ["edge-on-A", "edge-on-B"], ["ph2co", "c18o"]),
            (1010, 1230, ["face-on", "edge-on-A", "edge-on-B"], ["ph2co"]),
            (1340, 1500, ["face-on", "edge-on-B"], ["ph2co", "c18o"]),
            (1630, 1740, ["face-on", "edge-on-A", "edge-on-B"], ["ph2co", "c18o"]),
            (1930, 2150, ["face-on", "edge-on-A"], ["ph2co", "c18o"]),
            (1950, 2010, ["face-on", "edge-on-A"], ["ph2co", "c18o"])],
      ...
      82 : [(330, 470, ["face-on", "edge-on-A", "edge-on-B"], ["ph2co", "c18o"]),
      ...
      162: [(460, 500, ["face-on", "edge-on-B"], ["ph2co", "c18o"]),
            ...
            (1200, 1450, ["face-on", "edge-on-B"], ["ph2co", "c18o"]),
            (1460, 1490, ["face-on", "edge-on-B"], ["ph2co", "c18o"]),
            (1670, 2040, ["face-on", "edge-on-A"], ["ph2co", "c18o"]),
...
candidatenote_dir = {
      6  : ["East in both face on + edge on (A). Rotates -90 degrees at 340->350, so changes velocity in (A)",
            ...
            "Flips 180 degrees at 600->610, starts S->NW (face-on), so left in (A), right in (B)",
            "Continuation of above, but dips out in 700, so separated event. Now W in both face on and (A)",
            "Maybe starts in 790, but then disappears a bit. North in face on, E in (B). Flips a couple times",
            "North in face on, west in edge on (A) and east in (B)",],

      13 : ["N spiral in face on, E in (B). Flips to N and W from 450->460.",
            "SW in (A) and SE in (B). Not that visible in face on. Flips 180 in 1000->1010. Dissolves in 1050",
            "Spirals in from N in face on, slightly NW in (A) and slightly NE in (B). Later only in (B)",
            "Spiral on southeastern side, shown on western side in (B)",
            "South spiral/arm thing in face on. From east below in (A), in (B) on eastern side",
            "NE in face on, E in (A), might also be visible in (B) due to spiral structure, but no gradient",
            "West in face on, long filament coming down from above west in (A). Joins below disk"],
      ...
      82 : ["Northwest in face on, west in (A) and east in (B). Turns north. Disappears in (A) ~450",
            ...
            "Northeast in face on. Turns directly north. East in (A). Becomes more visible southeast in (B)",
            "Slightly NW in face on. Seen east in (B). Event turns counterclockwise, shows up west in (A)",
            "Directly south in face on. West in (B). Moves towards, connects then fades."],

      122: ["North in face on. Shows up east in (B). Also slightly visible east in (A)",
            "South in face on, west in (B). Turns clockwise to near west face on and shows up west in (A)",
      ...
      162: ["Northern spiral in face on. Seen east in (B)",
            ...
            "Technically two in east, but dominant SE collimated thing in (B). East in face on",
